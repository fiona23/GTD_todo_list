define(['util', 'defaults', 'categoryData'], function ($, defaults, categoryData) {
        ...
        showCategory: function  () {
            ...
            console.log($('.'+defaults.cateL2)[0] && $('.'+defaults.cateL2)[0].length)
            //add active task
           // if ($('.'+defaults.cateL2)[0] && $('.'+defaults.cateL2)[0].length) {
            ...
            //}
                ...
                function taskClick (ele) {
                    $.on(ele, 'click', function () {
                        ...
                        $('.task-wrapper')[0].innerHTML = '<div id="pending"></div><div id="completed"></div>';
                        init.showTaskList();
                        //显示该分类下第一个任务
                        init.showTaskDetail();
        ...
        showTaskList: function (choosedClass) {
            ...
            if (_data[params]['className'] === choosedClass) {
                ...
                if (condition) {
                    ...
                    //addClass(newDayTask, _data[params]['className']);
